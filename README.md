...
A complete multi-GPU accelerated finite element solver which was initially developed as part of a topics course is available here [here](https://github.com/paranumal/libparanumal). 